	...
	return (
		<ResizablePrimitiveSeparator
			className={cn(
				...
				"data-[orientation=horizontal]:after:left-0 data-[orientation=horizontal]:after:h-1 data-[orientation=horizontal]:after:w-full data-[orientation=horizontal]:after:-translate-y-1/2 data-[orientation=horizontal]:after:translate-x-0",
